...
//hien thi them chuyen nganh
$sql = "SELECT student.id, fullname, email, Birthday, major_id, name_major FROM student,major WHERE student.major_id=major.id";
...
<table  
border=1><tr><th>ID</th><th>Hoten</th><th>email</th><th>Ma CN</th><th>Ten CN</th><th>ngaysinh</th><th colspan="2">Hanh dong</th></tr> 
<?php  
